...
total_minutes = number_of_lectures * minutes_per_lecture  # No spaces in variable names, undefined variable
...
print(f"The class {school_class} is held at {school} over {number_of_lectures} lectures for at total of {total_hours} hours and {remaining_minutes} minutes")
